    ...
    <div class="min-h-screen">
        ...
        <main>
            <section class="lg:px-[15%] px-[5%] ">
				...
				<div class="grid grid-cols-[3fr,1fr] gap-20"> 
					<div class="auto-cols-max"> 
						...
						<div class="my-4">
						<h2 class="text-3xl font-semibold my-4">Voordelen van Value Betting</h2>
						...
						<h2 class="text-3xl font-semibold my-4">Nadelen van Value Betting</h2>
						...
						<h2 class="text-3xl font-semibold mb-y ">Nadelen van Value Betting</h2>
						...
						<h2 class="text-3xl font-semibold mb-4">Toepassen van Value Betting toe in je strategie </h2>

						<h3 class="text-2xl font-semibold mb-4">Statistieken analyseren </h3>
						<p class="mb-4">
						...
						<h3 class="text-2xl font-semibold mb-4">Vergelijk odds</h3>
						<p class="mb-4">
						...
						<h3 class="text-2xl font-semibold mb-4">Beheer je bankroll</h3>
						<p class="mb-4">
...
<h3 class="text-2xl font-semibold mb-4">Ontdek meer over Value Betting </h3>
<p class="mb-4">
