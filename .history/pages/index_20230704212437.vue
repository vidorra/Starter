		...
		<main>
            ...
            <section class="lg:px-[15%] px-[5%] py-20 bg-default grid grid-cols-1 align-center lg:grid-cols-2 gap-5">
				<div class="container-banner flex flex-col items-center"> 
                    <h1
					class="lg:text-5xl text-2xl font-notosans leading-normal font-semibold text-left"
				>
					Maximaliseer je sportweddenschappen met winststrategieën
				</h1>
                <h5 class="text-secondary">Ontdek de kracht van data-analyse en slimme weddenschapsselectie voor langdurig succes</h5> 
                </div>
