	...
	<div class="min-h-screen">
		...
		<main>
            ...
            <section class="lg:px-[15%] px-[5%] py-20  grid grid-cols-1 items-center lg:grid-cols-2 gap-5">
				<div class="container-banner flex flex-col items-center"> 
				...
				<a href="/value-betting" class="bg-secondary rounded-l-full rounded-r-md py-2 px-4 text-white font-semibold">
