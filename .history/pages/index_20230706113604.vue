	...
	<div class="min-h-screen">
		...
		<main>
            ...
            <section class="lg:px-[15%] px-[5%] py-20  grid grid-cols-1 items-center lg:grid-cols-2 gap-5">
                ...
                <h5 class="text-2xl font-regular leading-snug text-gray-400">
				...
				<div class="grow"> 
					<a href="/value-betting" class="bg-secondary inline-block mt-10 rounded-md py-3 px-6 text-white text-xl font-normal">
