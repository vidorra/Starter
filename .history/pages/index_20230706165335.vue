		...
		<main>
			...
			<section class="lg:px-[20%] px-[5%] py-20  flex items-center ">
                ...
                <h5 class="text-xl font-normal	 leading-snug text-fontcolor">
					...
					<br/><br/>
					Door deze gestructureerde aanpak kun je trends identificeren, sterke en zwakke punten ontdekken en waardevol inzicht krijgen in de prestaties van de teams. Leer hoe je deze methode kunt toepassen om weloverwogen beslissingen te nemen en je kansen op succesvolle sportweddenschappen te vergroten.				</h5> 
				<a href="/wedstrijdanalyse" class="text-underline text-primary hover:text-bold">
					Lees meer >
				</a>
