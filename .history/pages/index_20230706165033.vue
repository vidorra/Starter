	...
	<div class="min-h-screen">
		...
		<main>
			...
			<section class="lg:px-[20%] px-[5%] py-20  flex items-center ">
                ...
                <h5 class="text-xl font-normal	 leading-snug text-fontcolor">
					Ontdek waardevolle inzichten in onze wedstrijdanalyses. We analyseren de laatste 8 resultaten van de betrokken teams, inclusief het verschil tussen uit- en thuisresultaten, de vorm van de teams en hun rangschikking op de competitietabel. Vertrouw op onze gedetailleerde analyses om trends, sterke en zwakke punten te identificeren en een dieper inzicht te krijgen in de prestaties van de teams. Neem weloverwogen beslissingen en vergroot je kansen op succesvolle sportweddenschappen.
				</h5> 
