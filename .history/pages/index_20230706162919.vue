		...
		<main>
			...
			<section class="usp lg:px-[15%]  ">
				<div class="rounded-2xl	  bg-white px-4 py-6 flex flex-row grid grid-cols-3 items-center lg:grid-cols-3 gap-5">
					<span class="text-fontcolor text-xl font-normal flex flex-col items-center">  <img class="w-12 mr-8" src="assets/img/chip.png" /> 	Bewezen resultaten</span>
					<span class="text-fontcolor text-xl font-normal flex flex-col items-center"><img class="w-12 mr-8" src="assets/img/chip.png" /> Gratis strategieën en tips</span>
					<span class="text-fontcolor text-xl font-normal flex flex-col items-center"><img class="w-12 mr-8" src="assets/img/chip.png" />  Duurzame winstgevendheid</span>
				</div>
			</section>
			...
			<section class="lg:px-[20%] px-[5%] py-20  flex items-center ">
				<div class="container-banner grow mr-20 items-center justify-start"> 
					...
					<h3 class="text-4xl font-lato w-full leading-tight text-fontcolor font-bold  text-left mb-10 ">
						Wedstrijdanalyse methode voor voetbalwedstrijden
					</h3>
                <h5 class="text-2xl font-normal	 leading-snug text-fontlightcolor">
					"Ontdek de kracht van data-analyse en slimme weddenschapsselectie voor stabiel succes in sportweddenschappen. Bereik duurzame winsten door waarde te vinden in de odds en strategisch te wedden."
				</h5> 
