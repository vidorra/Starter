	...
	<div class="min-h-screen">
		...
		<main>
			...
			<section class="usp lg:px-[15%]  ">
				<div class="  flex flex-row grid grid-cols-3 items-center lg:grid-cols-3 gap-5">
					<div class="text-fontcolor complex-gradient2 rounded-2xl	  px-4 py-6  text-xl font-semibold flex flex-col items-center">  
