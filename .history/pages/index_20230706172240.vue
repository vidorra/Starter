				...
				<div>  
					...
					>
						<div>
                                ...
                                <NuxtLink  class="text-lg mb-4 font-semibold primary" :to="b._path" >
                                    {{ b.title }}
                                </NuxtLink>
							...
							<ul
								v-if="b.children"
								class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8 mt-2"
							>
								...
								>
									<li
										class="list-item text-default text-gray-600 hover:text-primary-900 underline underline-offset-4 decoration-wavy decoration-primary/40 hover:decoration-primary transition-all "
									>
                                    <div class="px-7 py-5 rounded-lg bg-backround">
