	...
	<div class="min-h-screen">
		...
		<main>
            ...
            <section class="lg:px-[15%] px-[5%] py-20  grid grid-cols-1 items-center lg:grid-cols-2 gap-5">
                ...
                <h5 class="text-2xl font-normal	 leading-snug text-fontlightcolor">
				...
				<div class="w-full"> 
					<a href="/value-betting" class="bg-primary hover:bg-secondary font-semibold inline-block mt-10 rounded-md text-2xl py-4 px-8 text-white text-xl font-normal">
			...
			<section class="usp lg:px-[15%]  ">
				<div class="rounded-md  bg-white px-4 py-6 flex flex-row grid grid-cols-3 items-center lg:grid-cols-3 gap-5">
					<span class="text-fontcolor text-xl font-normal flex items-center">  <img class="w-12 mr-4" src="assets/img/chip.png" /> 	Bewezen resultaten</span>
					<span class="text-fontcolor text-xl font-normal flex items-center"><img class="w-12 mr-4" src="assets/img/chip.png" /> Gratis strategieën en tips</span>
					<span class="text-fontcolor text-xl font-normal flex items-center"><img class="w-12 mr-4" src="assets/img/chip.png" />  Duurzame winstgevendheid</span>
				</div>
			</section>

			<section class="lg:px-[18%] px-[5%] py-20  flex items-center ">
				<div class="container-banner grow  items-center justify-start"> 
                ...
                <img class="rounded-lg w-2w/5" src="assets/img/home-1.jpg" /> 	
			</section>

             <section class="lg:px-[15%] px-[5%] lg:pt-20 lg:pb-20 ">
				<p class="text-center uppercase font-medium tracking-wider mb-2 text-gray-500 mb-5"> 
				services
				</p>
				<div>  
					<template
