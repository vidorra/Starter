	...
	<div class="min-h-screen">
		...
		<main>
            ...
            <section class="lg:px-[15%] px-[5%] py-20 bg-default grid grid-cols-1 align-center lg:grid-cols-2 gap-5">
				...
				>
					Haal het maximale uit je sportweddenschappen met onze winststrategieën
				</h1>
                <h5>Ontdek de kracht van data-analyse en slimme weddenschapsselectie voor langdurig succes</h5> 
                </div>
