		...
		<main>
			...
			<section class="usp lg:px-[15%]  ">
				<div class="rounded-md  bg-white px-4 py-10 flex flex-row grid grid-cols-3 items-center lg:grid-cols-3 gap-5">
					<span class="text-fontcolor text-xl font-normal">Bewezen resultaten</span>
					<span class="text-fontcolor text-xl font-normal">Gratis strategieën en tips</span>
					<span class="text-fontcolor text-xl font-normal">Duurzame winstgevendheid</span>
				</div>
			</section>
