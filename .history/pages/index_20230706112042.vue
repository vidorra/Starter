		...
		<main>
            ...
            <section class="lg:px-[15%] px-[5%] py-20  grid grid-cols-1 items-center lg:grid-cols-2 gap-5">
				<div class="container-banner flex flex-col items-center justify-start"> 
                    <h1 class="text-6xl font-notosans leading-snug text-fontcolor font-bold text-left mb-10 ">
						Ontdek winstgevende <span class="text-secondary">sportweddenschappen</span> strategieën voor succes
				</h1>
                <h5 class="text-2xl leading-snug text-primary">Ontdek de kracht van data-analyse en slimme weddenschapsselectie voor langdurig succes</h5> 
		

				<div class="grow"> 
				<a href="/value-betting" class="bg-secondary mr-10 rounded-md py-3 px-6 text-white text-xl font-normal">

					Ontdek de kracht van data-analyse en slimme weddenschapsselectie voor consistent succes in sportweddenschappen. Bereik stabiele winsten door waarde te vinden in de odds en strategisch te wedden. Til je sportweddenschappen naar een hoger niveau van duurzaam rendement.
				</a>
				</div>
