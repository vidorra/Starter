		...
		<main>
            ...
            <section class="lg:px-[15%] px-[5%] py-20  grid grid-cols-1 items-center lg:grid-cols-2 gap-5">
				<div class="container-banner flex flex-col items-center justify-start"> 
                    <h1 class="text-6xl font-spacegrotesk leading-snug text-fontcolor font-bold text-left mb-10 ">
				...
				<div class="w-full"> 
					<a href="/value-betting" class="bg-primary inline-block mt-10 rounded-md text-2xl py-3 px-6 text-white text-xl font-normal">
